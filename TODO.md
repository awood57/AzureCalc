...
[x] - Refactor the storage services to use inheritance, not an immediate problem, but when it gets to 3 or more tables, the repetition becomes messy.
Frontend:
[x] - Finish unit conversion page and controller
[x] - Add Unit Conversions to history page
